  ...
  return (
      <CountProvider user_Id={uid}>
        <header className="flex flex-col  text-gray-400">
          ...
          <nav className="h-[74px] bg-[#FFFFFF] flex justify-between px-8 lg:px-48 items-center border-b border-b-gray-200">
            <ul className="flex text-[#636270] font-sans text-sm gap-x-8 ">
              <li>
              <Link href="/">
               Home </Link>
                </li>
        ...
        <footer className="border-t border-t-gray-300 lg:max-w-full ">
          <section className="lg:max-w-[1150px]  lg:h-[343px] flex lg:space-x-10 mx-7 my-10 lg:px-48 lg:py-20">
            <section className="">
              <div className="flex gap-x-4 items-center pt-1.5">
                <Image src={"/sofa.png"} alt="sofa" width={40} height={40} />
                <h1 className="text-2xl font-sans font-semibold">Comforty</h1>
              </div>
              <p className="w-full lg:w-80 text-[#272343] my-6">Vivamus tristique odio sit amet velit semper, eu posuere turpis interdum.
                Cras egestas purus
                <span className="flex gap-x-10 lg:gap-x-6 my-6">
                  ...
                  <Image src={"/YouTube---Negative 1.png"} alt={"Youtube"} width={16} height={16}  unoptimized  className="hover:rounded-full hover:cursor-pointer hover:border hover:border-[#007580]" />
                </span>
              </p>
            </section>
          <section className="">
            <h1 className="hidden lg:flex font-sans text-sm text-[#9A9CAA] uppercase">
              Category
            </h1>
            <ul className="hidden lg:flex lg:flex-col font-sans text-base text-[#272343] py-4 space-y-3  whitespace-nowrap w-max">
          ...
          <section className="">
            <h1 className="hidden lg:flex text-[#9A9CAA] font-[inter] text-sm uppercase">
              Support
            </h1>
            <ul className="text-base hidden lg:flex lg:flex-col text-[#272343] font-[inter] font-[400] whitespace-nowrap w-max space-y-3 py-4">
          ...
          <section className="">
            <h1 className="uppercase hidden lg:flex text-[#9A9CAA] text-sm">Newsletter</h1>
            <form className="py-8 hidden lg:flex  gap-x-2">
            ...
            <p className="text-[#272343] text-[15px] font-sans hidden lg:flex">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam tincidunt erat enim.</p>
          </section>
          </section>

          <section className="h-20 flex flex-col lg:flex-row border-t  border-t-gray-300 w-full justify-between lg:py-10 lg:px-48 px-7 py-5 items-center gap-y-3">
            <p className="text-[#9A9CAA] font-sans text-sm">
              @ 2025 - Comforty - Designed & Develop by Saim
            </p>
            <span className="flex gap-x-4 lg:gap-x-2  items-center">
