...
const targetClient = createClient({
  projectId: SANITY_PROJECT_ID, // Your Sanity project ID
  dataset: SANITY_DATASET || "production", // Default to "production" if not set
  useCdn: false, // Disable CDN for real-time updates
  apiVersion:"2025-07-26", // Sanity API version
